jQuery.fn.pagination = function(maxentries, opts) {
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			//设置跳到第几页
			if(opts.setPageNo){
				  panel.append("<div class='goto'><span class='text'>Jump to page</span><input type='text'/><span class='page'></span><button type='button' class='ue-button long2'>确定</button></div>");
			}
		}
